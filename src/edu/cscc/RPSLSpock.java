...
/**
 * Base class for "Rock, Paper, Scissors, Lizard, Spock" game
 * @author Reinhard Bare
 */
public class RPSLSpock {
    ...
    /**
     * Boolean
     * @param pick: String value chosen by user; several predefined choices (rock, paper, scissors, lizard, spock)
     * @return pick is true if input value is valid (equalsIgnoreCase) or false if "null" (is not any of the existing choices)
     */
    ...
    /**
     * @return generates random pick from predefined choices and breaks once generated
     */
    ...
    /**
     * Boolean
     * @param c_pick = Computer pick: computer-chosen pick value
     * @param h_pick = Human pick: user-inputted pick value
     * @return results of the game: compares computer and human picks against game rules and determines a victor
     * Rule example: (lizard beats spock, lizard eats paper)
     */
